...
// 	start={bool}
//	stopOn={int optional} send or it will not stop!
//  stopListener={func optional} return id
// />
...
class Timer extends Component{
    ...
    componentDidMount(){
    	...
    	if(this.props.stopOn){this.stopOn = this.props.stopOn} else {this.stopOn = 0}
    }
    ...
    componentDidUpdate(prev){
        ...
        if(prev.seconds !== this.props.seconds){
    ...
    tick(){
    	this.setState((state)=>{
            ...
            if(this.props.stopOn !== undefined && this.props.stopOn === parseInt(timer)){
